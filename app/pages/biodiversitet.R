...
Selv om det er mange sjeldne arter, er det flere tusen arter som blir funnet relativt ofte. Dette gjør at vi er i stand til  å undersøke forskjeller mellom naturtyper og overvåke endringer over tid. Hvilke arter vi har funnet kan også endres tilbake i tid. Det er mye DNA som vi ennå ikke kan koble til et artsnavn fordi ingen har registrert nettopp deres DNA i offentlige kilder. Dette gjelder fremfor alt de sjeldne artene, og spesielt tovinger og veps. For å forbedre denne situasjon samarbeider vi med NTNU Vitenskapsmuseet og har sørget for atflere hundre tidligere uregistrerte arter nå er tilgjengelig i DNA-bibliotekene. De DNA-varianter som fortsatt ikke får en treff i DNA-bibliotekene, deler vi inn i hypotetiske arter basert på den statistiske forskjellen mellom dem. Disse arter er altså et midlertidig beste estimat som kan komme å revideres. Per idag har overvåkingsprogrammet observert litt over 30 000 leddyr, der vi kan koble ca 11 000 til et kjent artsnavn.")
